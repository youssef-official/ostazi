...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.teacherassistant.app"
    minSdk = 24
    targetSdk = 36
    versionCode = 2
    versionName = "2.0"
  ...
  signingConfigs {
    create("release") {
      val keystorePath = releaseSigningProperties.getProperty("RELEASE_STORE_FILE")
        ?: System.getenv("KEYSTORE_PATH")
        ?: "${rootDir}/my-upload-key.jks"
      storeFile = file(keystorePath)
      storePassword = releaseSigningProperties.getProperty("RELEASE_STORE_PASSWORD")
        ?: System.getenv("STORE_PASSWORD")
      keyAlias = releaseSigningProperties.getProperty("RELEASE_KEY_ALIAS") ?: "upload"
